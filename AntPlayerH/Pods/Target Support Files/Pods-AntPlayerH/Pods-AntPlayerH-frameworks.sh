...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/AHDownloadButton/AHDownloadButton.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ScreenshotPreventing/ScreenshotPreventing.framework"
